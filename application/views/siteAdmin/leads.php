...
<a href="https://bestpropertiesmohali.com/admin/leads/export_page" style="float: right;margin-left: 4px;" class="btn btn-sm btn-success back-btn">Export</a>    </div>
    </div>
    <div class="clearfix"></div>
    <script>
  $(document).ready(function() {
    $('.advance-search-btn').click(function() {
      $('.advance-search').slideToggle('fast'); // or use 'slow' for slower effect
    });
  });
</script>
    ...
    <div class="row advance-search" style="display: none;">
        ...
        <div class="form-group ">
            ...
            <select name="status" class="form-control">
                ...
                <option value="Contacted" <?php if(isset($_POST['status']) && $_POST['status'] == 'Contacted') echo 'selected'; ?>>Contacted</option>
                <option value="Qualified" <?php if(isset($_POST['status']) && $_POST['status'] == 'Qualified') echo 'selected'; ?>>Qualified</option> 
                <option value="Site Visit Scheduled" <?php if(isset($_POST['status']) && $_POST['status'] == 'Site Visit Scheduled') echo 'selected'; ?>>Site Visit Scheduled</option> 
                <option value="Site Visited" <?php if(isset($_POST['status']) && $_POST['status'] == 'Site Visited') echo 'selected'; ?>>Site Visited</option>  
                <option value="Negotiation" <?php if(isset($_POST['status']) && $_POST['status'] == 'Negotiation') echo 'selected'; ?>>Negotiation</option> 
                <option value="Booking Confirmed" <?php if(isset($_POST['status']) && $_POST['status'] == 'Booking Confirmed') echo 'selected'; ?>>Booking Confirmed</option>
                <option value="Document Collection" <?php if(isset($_POST['status']) && $_POST['status'] == 'Document Collection') echo 'selected'; ?>>Document Collection</option>
                <option value="Loan Under Process" <?php if(isset($_POST['status']) && $_POST['status'] == 'Loan Under Process') echo 'selected'; ?>>Loan Under Process</option>
                <option value="Finalized / Closed" <?php if(isset($_POST['status']) && $_POST['status'] == 'Finalized / Closed') echo 'selected'; ?>>Finalized / Closed</option>
                <option value="Follow-up Later" <?php if(isset($_POST['status']) && $_POST['status'] == 'Follow-up Later') echo 'selected'; ?>>Follow-up Later</option>
                <option value="Not Interested" <?php if(isset($_POST['status']) && $_POST['status'] == 'Not Interested') echo 'selected'; ?>>Not Interested</option>
                <option value="Duplicate" <?php if(isset($_POST['status']) && $_POST['status'] == 'Duplicate') echo 'selected'; ?>>Duplicate</option>
                <option value="Invalid Lead" <?php if(isset($_POST['status']) && $_POST['status'] == 'Invalid Lead') echo 'selected'; ?>>Invalid Lead</option>
            </select>
        </div>
