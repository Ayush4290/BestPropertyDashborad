         ...
         <div class="col-sm-3">
            ...
            <div class="form-group">
                ...
                <select name="timeline" class="form-control">
                    <option value="">Select</option>
                    <option <?php if($info->timeline=='Argent'){ echo 'selected'; }?> value="Argent">Argent</option>
                    <option <?php if($info->timeline=='Within the week'){ echo 'selected'; }?> value="Within the week">Within the week</option>
                    <option <?php if($info->timeline=='Within the mounths'){ echo 'selected'; }?> value="Within the week">Within the mounths</option>
                    <option <?php if($info->timeline=='Up to 6 mounths'){ echo 'selected'; }?> value="Up to 6 mounths">Up to 6 mounths</option>
