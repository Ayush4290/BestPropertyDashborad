...
<?php endif; ?>
    ...
    <div class="row">
      ...
      <!-- Type -->
        ...
        <!-- BHK -->
        <div class="form-group col-sm-3" id="bhkGroup" style="display: none;">
            <label>BHK:</label>
        ...
        if(!empty($properties)) {
            ...
            <tr>
               ...
               <td>
                ...
                <td>
                    <a href="<?php echo base_url().'admin/properties/edit/'.$property->id;?>" class="btn btn-success btn-sm">Edit</a>
                    <?php if ($this->session->userdata('role') !== 'Agent'): ?>
                        <a href="<?php echo base_url().'admin/properties/delete/'.$property->id;?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                    <?php endif; ?>
                    <?php if ($this->session->userdata('role') === 'Agent'): ?>
 ...
 <script>
    ...
    if (jQuery(this).is(':checked')) {
        ...
        $.ajax({
			...
			//data:"field="+field,
			data: {status: status,list_id:dat_id},
...
$("#applyStatus").click(function(){
    ...
    $.ajax({
        ...
        method: "POST",
        data: {property_ids: propertyIds, status: status},
